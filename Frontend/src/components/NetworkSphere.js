...
export function NetworkSphere({ className = '' }) {
    ...
    useEffect(() => {
        ...
        const project = (node, cx, cy, radius) => {
    ...
    return (_jsx("canvas", { ref: canvasRef, className: `w-full h-full ${className}`, style: { aspectRatio: '1', filter: 'drop-shadow(0 0 40px rgba(0, 230, 118, 0.3))' } }));
}
